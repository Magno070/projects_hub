...
Future<void> configureDependencies() async {
  ...
  // ViewModels
  getIt.registerFactory<DiscountsTableViewModel>(
    () => DiscountsTableViewModel(
      updateNicknameUseCase: getIt<UpdateDiscountNicknameUseCase>(),
      getDiscountTableUseCase: getIt<GetDiscountTableUseCase>(),
    ),
  );
}
